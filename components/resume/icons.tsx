...
export function isFilledResumeIcon(icon: ResumeIcon): boolean {
  return FILLED_ICON_IDS.has(icon);
}

function brandIcon(name: string, path: string): LucideIcon {
  const Icon = forwardRef<SVGSVGElement, LucideProps>(function BrandMark(
